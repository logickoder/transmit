...
export default function HomeWhatSection() {
    return (
        <section className="flex flex-col m-auto mt-16 md:mt-[8.25rem] w-full md:w-h px-h md:px-0">
            <h1 className="text-heading font-medium mb-[3.81rem] text-decorated">What can you do with<br/>Transmit
                solution?</h1>
...
function Card({index, title, content}: { index: number, title: string, content: string }) {
    ...
    return (
        ...
        >
            ...
            <h2 className="text-heading2 font-semibold text-decorated">{title}</h2>
